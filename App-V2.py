...
Takes photos only when motion is detected, saves to date-based folders
“””
...
def **init**(self, camera_id=0, sensitivity=1000, photo_interval=2.0,
...
def create_session_directory(self):
    ...
    # Create directory name based on current date and time
        ...
        while self.running:
            ...
            if motion_detected:
                if not self.motion_detected:
                    ...
                    self.photo_count = 0
                    # Create new session directory for this detection sequence
                    self.create_session_directory()
                ...
                if (self.motion_detected and 
                    ...
                    self.motion_detected = False
                    # Reset session directory so next motion creates a new one
                    self.current_session_dir = None
